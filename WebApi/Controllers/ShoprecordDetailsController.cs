...
namespace Travel.WebApi.Controllers
{
    ...
    public class ShoprecordDetailsController : ControllerBase
    {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<ShoprecordDetailDTO>> PostShoprecord(ShoprecordDetailDTO dto)
        {
            var shoprecordDetail = new ShoprecordDetail
            {
               
                MallProductName = dto.MallProductName,
                MallProductQuantity = dto.MallProductQuantity,
               MallProductTableId =dto.MallProductTableId,
